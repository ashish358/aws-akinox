  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        >
          FILTERS
          <ChevronRight className={`h-5  ${showFilter ? 'rotate-90' : '' }`} />
        </p>

        {/* Category Filter */}
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block mb-2`}>

        {/* <div className={`border border-gray-300 pl-5 py-3 mt-6 sm:hidden ${showFilter ? '' : 'hidden'}` } > */}
        ...
        {/* Sub Category Filter */}
        <div className={`border border-gray-300 pl-5 py-3 my-5sm:hidden ${showFilter ? '' : 'hidden'}` } >
          <p className="mb-3 text-sm font-medium">TYPE</p>
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input className="w-3" type="checkbox" value={'Analog'} onChange={tooggleSubCategory}  />Analog
            </p>
            <p className="flex gap-2">
        ...
        <div className="flex-1">
            <div className="flex justify-between text-base sm:text-2xl mb-4">
                ...
                <option value="relevant">Sort by: None</option>
